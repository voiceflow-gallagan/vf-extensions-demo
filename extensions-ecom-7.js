          ...
          if (uploadData.status === 'ok') {
            ...
            try {
              ...
              if (directLinkData.status === 'ok') {
                ...
                // Zet de directe link in een Voiceflow-variabele zonder deze aan de chat-interface toe te voegen
                window.voiceflow.chat.interact({
                    type: 'complete',
                    payload: {
                    file: directLinkData.data.productImageFileUrl // Zorg dat deze overeenkomt met hoe je het in Voiceflow verwacht
                    },
                });
              } else {
