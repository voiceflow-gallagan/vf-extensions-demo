...
export const KBUploadExtension = {
  ...
  type: 'response',
  match: ({ trace }) =>
    trace.payload?.name === 'ext_KBUpload',
  render: ({ trace, element }) => {
...
export const ConfettiExtension = {
  ...
  type: 'effect',
  match: ({ trace }) =>
    trace.payload?.name === 'ext_confetti',
  effect: ({ trace }) => {
...
export const FeedbackExtension = {
  ...
  type: 'response',
  match: ({ trace }) =>
    trace.payload?.name === 'ext_feedback',
  render: ({ trace, element }) => {
